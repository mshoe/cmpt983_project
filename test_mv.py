from util.bandit_util import DeterministicArmAcquiringMachine, StandardBanditMachine, MVGaussianBanditArm
...
initial_arms = [MVGaussianBanditArm(0.5, 0.5), MVGaussianBanditArm(0.3, 0.5)]
additional_arms = [MVGaussianBanditArm(0.6, 0.5), MVGaussianBanditArm(0.2, 0.5), MVGaussianBanditArm(0.8, 0.5)]
